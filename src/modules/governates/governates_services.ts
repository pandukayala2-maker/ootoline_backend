...
class GovernateServices {
    ...
    static find = async (filter: FilterQuery<GovernateDocument> = {}) => await GovernateModel.find(filter);
    static findById = async (id: string) => await GovernateModel.findById(id);
